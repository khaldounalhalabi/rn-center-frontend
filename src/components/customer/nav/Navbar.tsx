    ...
    <>
        ...
        >
            <div className={'w-full flex flex-col items-end'}>
                <XMark className={'w-8 h-8 mt-6 mr-6 cursor-pointer'} onClick={()=>{setShowSearchForm(false)}}/>
                <div className={'w-full flex justify-center  relative'}>
                    <div className={'absolute flex gap-2  top-0 items-center left-[5%] '}>
                        <SearchIcon className={'w-7 h-7  opacity-60'}/>
                        <h2 className={'font-light text-[#013567] text-[16px] md:text-[25px]'}>Search</h2>
                    </div>
                    <input type={'text'}
