  ...
  return <>
    <Grid md={2} gap={5}>
      <label className="label justify-start text-xl">
        Birth Date :{" "}
        <span className="ml-2 badge badge-outline  ">{patient?.birth_date}</span>
      </label>
      <label className="label justify-start text-xl">
        Age : <span className="ml-2 badge badge-accent  ">{patient?.age}</span>
      </label>
      <label className="label justify-start text-xl">
        Address :{" "}
      ...
      <label className="label justify-start text-xl">
        blood_group :{" "}
        <span className="ml-2 badge badge-accent  ">{patient?.blood_group}</span>
      </label>
      <label className="label justify-start text-xl">
        Is Blocked :{" "}
        {patient?.is_blocked ? (
