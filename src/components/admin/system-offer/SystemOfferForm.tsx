            ...
            <Grid md={"2"}>
                <ApiSelect
                    ...
                    api={(page, search): Promise<ApiResponse<Clinic[]>> =>
                        ClinicsService.make<ClinicsService>("admin").setHeaders({ filtered: true }).indexWithPagination(
                            page,
                            search,
                        )
                    }
                ...
                <div className={"flex w-full pl-2 my-3 justify-around"}>
                    <label className={"w-2/3"}>Allow Reuse : <span className="ml-1 text-red-600">*</span></label>
                    <div className={"w-1/3"}>
                        <Input
                            name={"allow_reuse"}
                            type="checkbox"
