...
export const pathnames = {
    ...
    '/admin/clinics/holidays/[holidayId]/edit':"/admin/clinics/holidays/[holidayId]/edit",
    ...
    '/admin/clinics/schedules/[clinicId]/edit':"/admin/clinics/schedules/[clinicId]/edit",
    ...
    '/admin/speciality/[specialityId]/edit':"/admin/speciality/[specialityId]/edit",
...
export const {Link, redirect, usePathname, useRouter} =
    createLocalizedPathnamesNavigation({locales,localePrefix, pathnames: pathnames as typeof pathnames & Record<string & {}, string>});