...
const TransactionsChartsAndCards = ({ role }: { role: RoleEnum }) => {
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("charts.balanceTrend.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("charts.incomeVsExpenses.description", {
...
export default TransactionsChartsAndCards;
