...
```
cd existing_repo
git remote add origin https://gitlab.com/pom9910507/pom-front.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pom9910507/pom-front/-/settings/integrations)
