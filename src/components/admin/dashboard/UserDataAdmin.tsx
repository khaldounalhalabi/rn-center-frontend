import {AdminStatistics} from "@/Models/DoctorStatistics";
...
const UserDataAdmin = ({statisticsRes,isLoading,isFetching}:{statisticsRes:AdminStatistics | undefined,isLoading:boolean,isFetching:boolean})=>{
