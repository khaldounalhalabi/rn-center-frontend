...
import AppointmentStatuses, {AppointmentStatusEnum} from "@/enum/AppointmentStatus";
...
const AppointmentStatusColumn = ({
  ...
  const handleSelectStatus = async (status: string, id: number,setSelected:React.Dispatch<string | undefined>) => {
