       ...
       <>
           <div className="navbar bg-base-100 justify-around">
               ...
               <div className="navbar-end pr-6">
                   ...
                   <MenuIcon className={'w-8 h-8 md:hidden'} onClick={()=>{setOpenNav(!openNav)}}/>
               </div>
           </div>
           <div className={`absolute  right-0 w-full  min-h-screen bg-white duration-500 transform ${openNav?"top-0 h-full":"-top-[100vh]"} z-[1000] md:hidden`}>
               <div className="navbar bg-base-100 justify-around">
                   <div className="navbar-start pl-8">
                       <UserIcon className={'w-6 h-6 fill-[#013567] mx-2'}/>
                   </div>
                   ...
                   <div className="navbar-end pr-6">
                       ...
                       <Close className={'w-8 h-8'} onClick={()=>{setOpenNav(!openNav)}}/>
                   </div>
               </div>
